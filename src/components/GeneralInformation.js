                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
                    ...
                    <div className="sm:col-span-4">
                        ...
                        <div className="relative">
                            ...
                            />
                            <UserIcon className="absolute left-3 top-3 h-5 w-5 text-gray-400" aria-hidden="true" />
                        </div>
                    </div>
                    {/* Email Address */}
                    <div className="sm:col-span-4">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="mt-2 block w-full rounded-lg bg-white px-4 py-2 text-base text-gray-900 border border-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-indigo-600 transition-all duration-200 pl-10" // Add padding for icon
                            />
                            <EnvelopeIcon className="absolute left-3 top-3 h-5 w-5 text-gray-400" aria-hidden="true" />
                        </div>
                    </div>
                    {/* Phone Number */}
                    <div className="sm:col-span-2 sm:col-start-1">
                        ...
                        <div className="relative">
                            ...
                            />
                            <PhoneArrowUpRightIcon className="absolute left-3 top-3 h-5 w-5 text-gray-400" aria-hidden="true" />
                        </div>
                    </div>
                    {/* Country */}

          ...
          <main className={`flex-1 transition-all duration-300 w-full `}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-4">
                <div className="flex flex-col justify-center">
                  ...
                  <p className="text-xl sm:text-2xl">
                    Welcome to the Diaspora Champions Challenge, where you win
                    twice. Enjoy fast and easy dispora banking banking services
                    and win big in the month of love.
                  </p>

                  <div className="inline-flex pt-6 gap-x-4">
                    <Link href="/participate">
                      <button className="bg-[#ff930a] hover:bg-gray-400 text-white font-bold py-2 px-4 rounded-lg">
                        Get Started
                      </button>
                    </Link>

                    <Link href="#about-the-campaign">
                      <button className="bg-[#212529] hover:bg-gray-400 text-white font-bold py-2 px-4 rounded-lg">
                        Learn More
                      </button>
                    </Link>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-4 mt-10">
                ...
                <div className="flex flex-col justify-center pb-8">
                  <p className="text-sm sm:text-base md:text-lg">
                    This challenge is your chance to engage in rewarding
                    actions, from opening accounts to taking quizzes, and earn
                    points that push you closer to exciting prizes. It's simple,
                    fun, and rewarding—just like banking with Credit Bank!
                  </p>
                  ...
                  <ul className="space-y-4 ml-8">
                    <li className="flex items-start space-x-4">
                      ...
                      <p className="md:text-lg text-sm sm:text-base">
                        Easy-to-join activities for everyone.
                      </p>
                    </li>
                    <li className="flex items-start space-x-4">
                      <div className="flex-shrink-0 w-6 h-6 bg-[#0cb4ab] text-white rounded-full flex items-center justify-center">
                      ...
                      <p className="md:text-lg text-sm sm:text-base">
                        A competitive leaderboard updated in real-time.
                      </p>
                    </li>
                    <li className="flex items-start space-x-4">
                      <div className="flex-shrink-0 w-6 h-6 bg-[#0cb4ab] text-white rounded-full flex items-center justify-center">
            ...
            <div className="bg-[#e7f7f7] px-10 md:px-40 pt-12 pb-10">
              <div className="grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-4">
                <div className="flex flex-col justify-center">
                  <Image
                    src="/assets/images/earn-points.png"
                    width={400}
                    height={100}
                ...
                <div
                  className="flex flex-col justify-center px-6 sm:px-10 md:px-20"
                  id="how-it-works"
                >
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-teal-600 mb-4">
                    ...
                    <ul className="flex flex-col space-y-8 w-full md:w-[35em] z-20">
                      <li className="flex items-start space-x-4 md:space-x-6 hover:translate-y-[-10px] transition-transform duration-300 ">
                        ...
                        <div>
                          ...
                          <span className="text-sm sm:text-base">
                            Provide your details to join and start tracking your
                            progress.
                          </span>
                        </div>
                      </li>
                      <li className="flex items-start space-x-4 md:space-x-6 hover:translate-y-[-10px] transition-transform duration-300 ">
                        ...
                        <div>
                          ...
                          <span className="text-sm sm:text-base">
                            Complete tasks like signing up, sending money, or
                            taking quizzes.
                          </span>
                        </div>
                      </li>
                      <li className="flex items-start space-x-4 md:space-x-6 hover:translate-y-[-10px] transition-transform duration-300 hover:cursor-pointer group">
                        ...
                        <div>
                          ...
                          <span className="text-sm sm:text-base">
                            Instantly gain points for every completed action and
                      ...
                      <li className="flex items-start space-x-4 md:space-x-6 hover:translate-y-[-10px] transition-transform duration-300 ">
                        ...
                        <div>
                          ...
                          <span className="text-sm sm:text-base">
                            Collect points, rank higher, and claim exciting
                            prizes tailored for you!
                          </span>
                        </div>
                      </li>
                    </ul>
            ...
            <div
              className="bg-white px-6 sm:px-10 md:px-20 pt-14 pb-12"
              id="actions"
            >
              <div className="flex flex-col justify-center text-center">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-teal-600 mb-4">
                  <span className="font-orange">Actions That</span> Earn You
                  Points
                </h2>
                <p className="text-base sm:text-lg">
                  Participate in these activities to earn points and climb the
                  leaderboard!
                </p>
              </div>
            ...
            <div
              className="bg-[#f7f1eb] px-6 sm:px-10 md:px-20 pt-14 pb-10"
              id="leaderboard"
            >
              <div className="flex flex-col justify-center text-center">
                <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-teal-600 mb-4">
                ...
                <p className="text-base sm:text-lg">
                  Stay competitive! Check the live leaderboard to see who's
                  winning.
                </p>
              </div>
                ...
                <div className="flex flex-col justify-center z-10">
                  ...
                  <ul className="space-y-4 ">
                    <li className="flex items-start space-x-4">
                      ...
                      <p className="md:text-lg text-sm sm:text-base text-white">
                        Earn points, stay ahead on the leaderboard, and claim
                        amazing prizes!
                      </p>
                    </li>
                    <li className="flex items-start space-x-4">
                      ...
                      <p className="md:text-lg text-sm sm:text-base text-white">
                        Rewards include Cashbacks and Credit Bank Merchandise.
                      </p>
                    </li>
                  </ul>
                  <div className="mt-8">
                    <Link href="/participate">
                      <button className="bg-[#0cb4ab] hover:bg-gray-400 text-white font-bold py-2 px-4 rounded-lg">
            ...
            <div className="bg-white px-6 sm:px-10 md:px-40 pt-10 pb-20">
              ...
              >
                <div className="flex flex-col mt-10">
                  ...
                  <p className="text-sm sm:text-base md:text-lg">
                    Take our fun and interactive quiz to earn 20 points
                    instantly. Test your knowledge, challenge yourself, and
                    climb the leaderboard. Every question gets you closer to
                    exciting rewards!
                  </p>
                  ...
                  <div className="">
                    <Link href="/participate">
                      <button className="bg-[#0cb4ab] hover:bg-gray-400 text-white font-bold py-2 px-10 rounded-lg">
                        Take the Quiz Now
                      </button>
                    </Link>
                  </div>
            ...
            <div
              className="bg-white px-6 sm:px-10 md:px-40 pt-10 pb-20 "
              id="quality-policy"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-10">
                <div className="flex flex-col p-4">
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-teal-600 mb-6">
                    <span className="font-orange">Quality Policy </span>{" "}
                    Statement
                  </h2>
                  <div className="text-sm sm:text-base md:text-lg text-black">
                    <p className="pb-6">
                      As an innovative Commercial Bank regulated by the Central
                      Bank of Kenya and that is responsive to its customers'
                      expectations, we commit to:{" "}
                    </p>
                    <div className="flex flex-col justify-center space-y-6 pl-4">
                      <span className="text-black">
                        1. Provide innovative financial solutions to all our
                        customers in a responsible and friendly manner.{" "}
                      </span>
                      <span className="text-black">
                        2. Provide innovative financial solutions to all our
                        customers in a responsible and friendly manner.{" "}
                      </span>
                      <span className="text-black">
                        3. Provide innovative financial solutions to all our
                        customers in a responsible and friendly manner.{" "}
                      </span>
                    </div>
                  </div>

...
// Function to calculate the next set of questions, considering multiple topics
    ...
    return (
        <div className="w-full">
            ...
            <main
                className={`flex-1 pt-14 p-4 md:p-8 min-h-screen transition-all duration-300 ${isSidebarOpen ? "ml-64" : "ml-10"} ${mode === "dark" ? "bg-[#0a0c1d] text-white" : "bg-[#f7f1eb] text-black"}`}>
                <div className="mb-12">

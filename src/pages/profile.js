                                                        ...
                                                        {countriesData && countriesData.length > 0 ? (
                                                            <div className="sm:col-span-2 ">
                                                                <Select
                                                                    ...
                                                                    isSearchable
                                                                    isClearable
                                                                    className="border border-gray-300 mt-2 block w-full rounded-lg bg-white text-base text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-indigo-600 transition-all duration-200" // Add padding for icon
                                                                />
